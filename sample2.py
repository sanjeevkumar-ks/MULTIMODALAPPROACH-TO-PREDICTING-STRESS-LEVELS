    ...
    def send_result_and_solution(self, stress_level, stress_percentage):
        if stress_percentage > 30:
            ...
            try:
                ...
                # Compose message
                result_message = f"Stress Level: {stress_level}\nStress Percentage: {stress_percentage}%"
                solution_message = ("Here are some tips to reduce stress: 1. Practice Deep Breathing: Engage in deep breathing exercises to activate the body's relaxation response.\n"
